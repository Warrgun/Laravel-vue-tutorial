    ...
    <GuestLayout>
        ...
        <form class="space-y-6" action="#" method="POST">
            <div>
                ...
                <div class="mt-2">
                    <input name="name" id="name" autocomplete="name" required="" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                </div>
            </div>
            <div>
            ...
            <div>
                <label for="passwordrepeat" class="block text-sm/6 font-medium text-gray-900">Repeat password</label>                
                <div class="mt-2">
                    <input type="password" name="passworderpeat" id="passwordrepeat" required="" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                </div>
            </div>
